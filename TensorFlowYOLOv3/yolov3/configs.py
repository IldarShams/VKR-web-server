...
TRAIN_CLASSES               = "./TensorFlowYOLOv3/model_data/license_plate_names.txt"
TRAIN_ANNOT_PATH            = "./TensorFlowYOLOv3/model_data/license_plate_train.txt"
TRAIN_LOGDIR                = "log"
TRAIN_CHECKPOINTS_FOLDER    = "./TensorFlowYOLOv3/checkpoints"
...
# TEST options
TEST_ANNOT_PATH             = "./model_data/license_plate_train.txt"
TEST_BATCH_SIZE             = 4
TEST_INPUT_SIZE             = 416
TEST_DATA_AUG               = False
